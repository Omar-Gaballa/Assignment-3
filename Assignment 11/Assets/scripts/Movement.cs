...
{
    // [SerializeField]  CinemachineVirtualCamera virtualCamera3P ;
    ...
    public void setPlayerCamer(CinemachineVirtualCamera virtualCamera3P){
        playerCamer = virtualCamera3P.transform;
    }
}
